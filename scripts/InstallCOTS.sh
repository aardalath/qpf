...
#### Installing COTS: II - Install PostgreSQL
...
say "commands:" 
say "  export PATH=/usr/lib64/qt5/bin:\$PATH"
say "  export LD_LIBRARY_PATH=/usr/lib64:\$LD_LIBRARY_PATH"
say "Done."
