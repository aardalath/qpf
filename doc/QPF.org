...
**** QLA-QPF-US-0100                           :Data Providers:
***** As a/an
...
****** Notes
- IF with external data provider/archive

**** QLA-QPF-US-0200                           :Data Providers:
***** As a/an
External Archive
***** I want to
provide an communication channel with QPF
***** so that
the system can request me data products
****** Notes
- IF with external data provider/archive

**** QLA-QPF-US-0300                           :Data Consumers:
***** As a/an
External Data User
***** I want to
open an interactive session
***** so that
I can check produced QLA reports
****** Notes
-

**** QLA-QPF-US-0400                           :Data Consumers:
***** As a/an
External Data User
***** I want to
receive QLA reports
***** so that
I'm informed of the QLA results
****** Notes
-

**** QLA-QPF-US-0500                           :Data Consumers:
***** As a/an
External Archive
***** I want to
receive QLA produced data
***** so that
I can store them for further use by third parties
****** Notes
-

**** QLA-QPF-US-0600                                          :Operations:
***** As a/an
Operator
***** I want to
have a configuration tool
***** so that
I can modify/adjust the configuration of the system
****** Notes
-

**** QLA-QPF-US-0700                                          :Operations:
***** As a/an
Operator
***** I want to
open an interactive session
***** so that
I can re-execute some of the processing tasks on stored data
****** Notes
-

**** QLA-QPF-US-0800                                          :Operations:
***** As a/an
Operator
***** I want to
be informed by the system of the different actions it take
***** so that
I can evaluate the overall system status
****** Notes
-

**** QLA-QPF-US-0900                                          :Operations:
***** As a/an
Operator
***** I want to
be informed of any alert produced by the system execution
***** so that
I can react and perform any mitigation activity
****** Notes
- system alerts

**** QLA-QPF-US-1000                                          :Operations:
***** As a/an
Operator
***** I want to
be informed of any repeating out-of-limits alert produced in the data processing
***** so that
I can start an additional evaluation of the data
****** Notes
- product alerts

**** QLA-QPF-US-1100                                          :Operations:
***** As a/an
Operator
***** I want to
know the status of the different processing tasks
***** so that
in case of system failure, I know the status of the system
****** Notes
-

**** QLA-QPF-US-1200                                          :Operations:
***** As a/an
Operator
***** I want to
be able to restart the system
***** so that
in case of system failure, the system returns to its state before the failure
****** Notes
- persistence

**** QLA-QPF-US-1300                                          :Operations:
***** As a/an
Operator
***** I want to
be able to modify the running status of the processing tasks
***** so that
I can pause/resume/stop a running task
****** Notes
-

**** QLA-QPF-US-1400                                          :Operations:
***** As a/an
Operator
***** I want to
be able to inject data from a used-defined repository (directory)
***** so that
the injected data is incorporated to the orchestration
****** Notes
-

**** QLA-QPF-US-1500                                          :Operations:
***** As a/an
Operator
***** I want to
look at the data stored in the local (temporary) archive
***** so that
I can process the data with other tools
****** Notes
-

**** QLA-QPF-US-1600                                          :Operations:
***** As a/an
Operator
***** I want to
look at the data stored in the local (temporary) archive
***** so that
reprocess some of the data products
****** Notes
-

**** QLA-QPF-US-1700                                          :Operations:
***** As a/an
Operator
***** I want to
have all the information of the system stored in a DB
***** so that
I can access all the information from external tools
****** Notes
-
