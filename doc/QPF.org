...
*** TODO Functionalities to be included [6/14]
...
**** TODO [#B] Prepare an infrastructure for product downloading
**** TODO [#B] Implement MONIT_RQST and MONIT_INFO messages
**** TODO [#B] Implement Commanding messages to handle running processors
**** TODO [#B] Implement output products registering and archival
**** TODO [#B] Pause/Resume/Stop of tasks
**** TODO [#B] Implement preferences for HMI
